...
export default function CatalogPage() {
  return (
    <div className="pb-20">
      <section className="border-b border-mercury px-6 pt-12 pb-16"><div className="mx-auto max-w-[1200px]"><h1 className="mb-6 font-display text-4xl font-bold md:text-6xl">Project<br /><span className="text-plasma">Catalog</span></h1><p className="max-w-2xl text-lg leading-relaxed text-ghost">Released and upcoming projects from our artist partners. Each project is fully owned by the artist. We exist to serve the work.</p></div></section>
