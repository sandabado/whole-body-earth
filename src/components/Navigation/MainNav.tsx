...
const EARTH_NAVIGATION: PillarNavigation = {
  links: [
    { href: "/#quincunx", label: "Quincunx" },
    { href: "/#presence", label: "Pillars" },
    { href: "/catalog", label: "Library" },
  ],
  cta: { href: "/#reading", label: "Get your reading →", accent: "constellation" },
};
...
export default function MainNav({ onMenuOpen }: MainNavProps) {
  ...
  const isStudios = pathname.startsWith("/pillars/studios");
