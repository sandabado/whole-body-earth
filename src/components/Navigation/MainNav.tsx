...
export function getPillarNavigation(pathname: string): PillarNavigation {
  ...
  return isGuardian ? GUARDIAN_NAVIGATION : isFoundation ? FOUNDATION_NAVIGATION : isPresence ? PRESENCE_NAVIGATION : isPress ? PRESS_NAVIGATION : isStudios ? STUDIOS_NAVIGATION : EARTH_NAVIGATION;
}
